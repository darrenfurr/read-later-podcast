 ...
 * @param {number} limit - Maximum number of articles to return (default: unlimited)
 */
export async function getNewArticles(limit = null) {
  const queryParams = {
    ...
    // Sort removed - Notion API doesn't need sorting for our use case
    // We process articles as they come
  };
